# switch_*_company_in_6_month — Agent Instructions
...
- **তিন repo-র কোড হুবহু এক** — পার্থক্য শুধু `app/lib/site.ts` (নাম, `slc6`/`src6`/`sgc6` prefix, `defaultStart` — লোকালে `2026-09-14`, বাকি দুটোয় `null`), `next.config.ts`-এর basePath আর `docs/`। কোড বদলালে তিনটাতেই একই বদল।
