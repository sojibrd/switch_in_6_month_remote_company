# switch_remote_company_in_6_month
...
এটা তিনটা বিকল্প plan-এর একটা। একজন একটাই চালায়: [লোকাল](https://github.com/sojibrd/switch_local_company_in_6_month) · **রিমোট** (এটা) · [গ্লোবাল](https://github.com/sojibrd/switch_global_company_in_6_month)। তিনটার কোড হুবহু এক।

**লাইভ:** https://sojibrd.github.io/switch_remote_company_in_6_month/
...
| ফাইল | দিন | Gist |
|---|---|---|
| [docs/00-rules.md](docs/00-rules.md) | — | লক্ষ্য (২০ আবেদন, ৫ process; সীমা $১,৭০০), সত্যের উৎস, বাজার (ইউরোপ আগে), তিন দরজা (remote-first · ভেটিং · কন্ট্রাক্ট), Ember-এর সুবিধা, সপ্তাহের ছন্দ আর DSA-র দুই সাইট (⏳ সময়ের অমিল), লেখার বসা, আবেদন ও interview-এর নিয়ম, Dip-এর নিয়ম, যা করবেন না, টাকা আনার ব্যবস্থা, দিন ১৮০-র পরে |
